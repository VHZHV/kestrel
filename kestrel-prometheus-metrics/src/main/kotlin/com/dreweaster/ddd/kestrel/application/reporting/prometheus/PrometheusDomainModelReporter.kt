...
class PrometheusDomainModelReporter : DomainModelReporter {
    ...
    companion object {
        ...
        val commandExecutionLatency: Summary = Summary.build()
        ...
        val commandExecution: Counter = Counter.build()
