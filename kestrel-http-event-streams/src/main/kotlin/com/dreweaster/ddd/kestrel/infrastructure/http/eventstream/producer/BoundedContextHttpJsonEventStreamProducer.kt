...
class BoundedContextHttpJsonEventStreamProducer(private val backend: Backend) {
    ...
    private suspend fun fetchEventStream(query: HttpJsonEventQuery): EventStream = if (query.afterTimestamp != null) {
    ...
    private fun convertStreamToJsonResponse(stream: EventStream) = jsonObject(
    ...
    private fun streamEventToJsonEvent(event: StreamEvent) = jsonObject(
