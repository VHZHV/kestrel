...
class Suspend : RuntimeException {
    ...
    constructor (failureCode: String, message: String) : super(message) {
        this.failureCode = failureCode
    }

    constructor (failureCode: String, message: String, cause: Throwable) : super(message, cause) {
        this.failureCode = failureCode
    }
}
...
interface ProcessManager<C : ProcessManagerContext, E : DomainEvent, S : ProcessManagerState> {
    ...
    fun processManager(
        ...
        startWith: S,
        endWith: S? = null,
        init: ProcessManagerBlueprint<C, E, S>.() -> Unit,
    ): ProcessManagerBlueprint<C, E, S> {
